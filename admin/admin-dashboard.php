...
<head>
    ...
    <title>Admin Dashboard - FeetHub</title>
    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a href="./admin-dashboard.php"><img src="../assests/images/home/logo.svg" alt="logo"></a>
            ...
            <div class="sidebar-nav">
                ...
                <a href="#sub-admins" class="nav-item" data-section="sub-admins">
                    <span class="nav-item-icon"><i class="bi bi-person-workspace"></i></span>
                    <span class="nav-item-label">Manage Sub Admins</span>
                </a>
        ...
        <main class="main-content">
            ...
            <div class="content">
                <!-- Dashboard Section -->
                <div class=" parent content-section active" id="dashboard">
                ...
                <!-- Sub Admins Section -->
                <div class="content-section" id="sub-admins">
                    <h2 class="page-heading">Sub Admin Management</h2>
                    <div class="section-card">
                        <div class="card-header">
                            <h3>All Sub Admins</h3>
                            <a href="./flows/create.php" class="btn-primary">Add New Sub Admin</a>
                        </div>
                        <div class="table-container">
                            <?php include_once('../flows/message.php'); ?>
                            <table class="orders-table">
                                ...
                                <tbody>
                                    <?php
                                    $query = "select * from sub_admins ORDER BY id DESC";
                                    $result = mysqli_query($connect, $query);
                                    if (mysqli_num_rows($result) > 0) {
                                        $rowid = 1;
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $managerMail; ?></td>
                                                <td
                                                    class="status-badge<?= ($userstatus == 'active') ? 'active' : 'inactive'; ?>">
                                                    <?= $userstatus; ?>
                                                </td>
                                                <td><?= $lastlogin; ?></td>
                                                <td>
                                                    <a href="./flows/view.php?sub_id=<?= $id ?>" class="btn-view">View</a>
                                                    <a href="./flows/edit.php?sub_id=<?= $id ?>" class="btn-edit">Edit</a>

                                                    <button class="del">
                                                        <?php if ($userstatus == "active") { ?>
                                                            <form action="./flows/process.php" method="post">
                                                                <input type="hidden" name="id" value=<?= $id; ?>>
                                                                <input type="submit" name="delete_subadmin" value="Delete"
                                                                    class="btn-delete">
                                                        ...
                                                        <?php } else { ?>
                                                            <form action="./flows/process.php" method="post">
                                                                <input type="hidden" name="id" value=<?= $id; ?>>
                                                                <input type="submit" name="add_subadmin" value="Revert"
                                                                    class="btn-revert">
