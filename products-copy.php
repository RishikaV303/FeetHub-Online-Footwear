            ...
            <div class="wrapper">
                <div class="cards">
                    ...
                    if (isset($_GET['search']) && !empty($_GET['search'])) {
                        ...
                        echo "<h4 style='text-align:start; margin-left: 75px;'>Search Results for '<span style='color:#ff4d4d;'>$search</span>'</h4>";

                        $query = "SELECT * FROM products WHERE status='active' AND (LOWER(product_name) LIKE LOWER('%$search%') OR LOWER(category) LIKE LOWER('%$search%') OR LOWER(Type) LIKE LOWER('%$search%')) ORDER BY product_id DESC";
                        ...
                        echo '<section class="product-section" style="padding:40px 0;">';
                        echo '<div class="product-container" style="display:flex;flex-wrap:wrap;gap:25px;justify-content:center;">';
