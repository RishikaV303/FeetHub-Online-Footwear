            ...
            <nav class="nav">
                <div class="wrap">
                    <div class="back">
                        ...
                        if ($product_id) {
                            ?>
                            <a href="../sub-admin.php#products"><i class="bi bi-arrow-left"></i>
                                <p>Back to Dashboard</p>
                            </a>
                        <?php
                        } elseif ($user_id) {
                            ?>
                            <a href="../sub-admin.php#users"><i class="bi bi-arrow-left"></i>
                                <p>Back to Dashboard</p>
                            </a>
                            <?php
                        } elseif ($order_id) {
                            ?>
                            <a href="../sub-admin.php#orders"><i class="bi bi-arrow-left"></i>
                                <p>Back to Dashboard</p>
                            </a>
                            <?php
                        } elseif ($recentorder_id) {
                            ?>
                            <a href="../sub-admin.php"><i class="bi bi-arrow-left"></i>
                                <p>Back to Dashboard</p>
                            </a>
                            <?php
                        }
